...
export default function WeekReview() {
  ...
  const renderMonthHoursComparison = (data: any) => {
    const hoursPreviousMonth = data?.weekReview?.monthSummary?.hoursPreviousMonth || 10;
    ...
    const hoursPreviousMonthUntilThisDate = data?.weekReview?.monthSummary?.hoursPreviousMonthUntilThisDate || 0;
      ...
      >
        ...
        >
          ...
          <div style={{ color: "#B77A00" }} className="text-right">
            ...
            <br />
            <span className="font-bold">
              {hoursPreviousMonth.toFixed(1)}h
            </span>
          </div>
        </motion.div>
      </motion.div>
    ...
    <>
      ...
      <div className="grid grid-cols-7 gap-2">
        <div className="col-span-2">
          { renderMonthHoursComparison(data) }
        </div>
      </div>
